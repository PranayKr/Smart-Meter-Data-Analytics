...
# multivariate multi-step encoder-decoder cnn-lstm for the power usage dataset
...
def load_pretrained_model(train, test, n_input):
    ...
    with open('models/CNN_Encoder_LSTM_Decoder_Seq2Seq_Multivariate_Model_architecture.json') as f:
        model = model_from_json(f.read())
    model.load_weights('models/CNN_Encoder_LSTM_Decoder_Seq2Seq_Multivariate_Model_Weights.h5')
